...
<!--
//指定当前组模块URL地址 
var URL = '/sae/fangyuanclub/1/index.php/Admin/Mmg';
...
location.href='/sae/fangyuanclub/1/index.php/Admin/Mmg/userList/id/'+groupId;
}
//-->
</script>
<!-- 主体内容  -->
...
<!-- 查询区域 -->
<div class="fRig">
<form method=post action="/sae/fangyuanclub/1/index.php/Admin/Mmg">
...
<table id="checkList" class="list" cellpadding=0 cellspacing=0 ><tr><td height="5" colspan="6" class="topTd" ></td></tr><tr class="row" ><th width="8"><input type="checkbox" id="check" onclick="CheckAll('checkList')"></th><th width="10%"><a href="javascript:sortBy('id','<?php echo ($sort); ?>','index')" title="按照编号<?php echo ($sortType); ?> ">编号<?php if(($order) == "id"): ?><img src="/sae/fangyuanclub/1/Public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('name','<?php echo ($sort); ?>','index')" title="按照组名<?php echo ($sortType); ?> ">组名<?php if(($order) == "name"): ?><img src="/sae/fangyuanclub/1/Public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('status','<?php echo ($sort); ?>','index')" title="按照状态<?php echo ($sortType); ?> ">状态<?php if(($order) == "status"): ?><img src="/sae/fangyuanclub/1/Public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th><a href="javascript:sortBy('remark','<?php echo ($sort); ?>','index')" title="按照描述<?php echo ($sortType); ?> ">描述<?php if(($order) == "remark"): ?><img src="/sae/fangyuanclub/1/Public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th >操作</th></tr><?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$action): $mod = ($i % 2 );++$i;?><tr class="row" ><td><input type="checkbox" name="key"	value="<?php echo ($action["id"]); ?>"></td><td><?php echo ($action["id"]); ?></td><td><a href="javascript:edit('<?php echo (addslashes($action["id"])); ?>')"><?php echo ($action["name"]); ?></a></td><td><?php echo (getstatus($action["status"])); ?></td><td><?php echo ($action["remark"]); ?></td><td> <?php echo (showstatus($action["status"],$action['id'])); ?>&nbsp; <a href="javascript:user('<?php echo ($action["id"]); ?>')">用户列表</a>&nbsp;</td></tr><?php endforeach; endif; else: echo "" ;endif; ?><tr><td height="5" colspan="6" class="bottomTd"></td></tr></table>
<!-- Think 系统列表组件结束 -->
